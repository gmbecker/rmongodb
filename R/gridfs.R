...
#' @param flags (int) = NULL, Optional. The value of the flags to set on the provided GridFile. Store here special flags such as: No MD5 calculation and Zlib Compression enabled.
...
mongo.gridfs.store.file <- function(gridfs, filename, remotename = "", contenttype = "", flags = NULL)
    .Call(".mongo.gridfs.store.file", gridfs, filename, remotename, contenttype, flags)
...
mongo.gridfs.store <- function(gridfs, raw, remotename, contenttype="", flags = NULL)
    .Call(".mongo.gridfs.store", gridfs, raw, remotename, contenttype, flags)
...
mongo.gridfile.writer.create <- function(gridfs, remotename, contenttype="", flags = NULL)
    .Call(".mongo.gridfile.writer.create", gridfs, remotename, contenttype, flags)
